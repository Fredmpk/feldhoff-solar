...
export default async function Contact() {
  ...
  return (
    <section
      className="pt-20 sm:pt-32 bg-cover bg-top md:bg-center bg-no-repeat sm:h-[90vh] flex flex-col rounded-b-lg"
      style={{
          ...
          <div className="w-full sm:w-1/3   p-4 ">
            <div className="w-full">
              <Card className=" bg-zinc-300 opacity-70 rounded-lg w-full">
                <CardContent className="p-6 space-y-4 w-full text-lg xl:text-xl text-black font-semibold text-right">
